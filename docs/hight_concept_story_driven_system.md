...
1. **Графа постов/новостей/заметок** (контентный слой).  
2. **Графа акторов (Actors)** — людей, компаний, стран, организаций и др., извлекаемых через NER и редакторскую курацию.  
